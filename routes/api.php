...
Route::get('/showAllUser',[userController::class, 'showAllUser']);
...
Route::post('/addPdfBook',[PdfBookController::class, 'addPdfBook']);
Route::get('/showAllPdf',[PdfBookController::class, 'showAllPdf']);
Route::post('/editPdf',[PdfBookController::class, 'editPdf']);
Route::post('/deletePdfBook',[PdfBookController::class, 'deletePdfBook']);

Route::post('/addSuggestion',[SuggestionController::class, 'addSuggestion']);
Route::get('/showSuggestion',[SuggestionController::class, 'showSuggestion']);
